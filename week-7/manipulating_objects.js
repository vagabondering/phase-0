...
// I had trouble adding the children names as objects with properties, I didn't think that an additional object to contain the key and value was needed. As soon as I added that additional object first and then assigned it the name key and value then I got it to pass.


// How difficult was it to add and delete properties outside of the object itself?
// Deleting wasn't too hard, adding was a bit more tricky when involving key and value.


// What did you learn about manipulating objects in this challenge?
// I learned that you can nest an object with a key and value within an object, and that you can nest the nested object with objects of keys and values.
// I also learned that you can access keys with . and their name and go as deep as you need to access the subobjects.
